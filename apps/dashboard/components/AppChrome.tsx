      ...
      <nav className="fixed top-0 z-50 w-full border-b border-white/10 bg-obsidian/75 backdrop-blur-xl">
        <div className="mx-auto flex h-16 max-w-7xl items-center justify-between px-6">
          ...
          <div className="hidden gap-5 md:flex">
            ...
            <a href="/leaderboard" className="text-sm text-stone/80 transition hover:text-parchment">
              Leaderboard
            </a>
            <a href="/quests" className="text-sm text-stone/80 transition hover:text-parchment">
              Quests
            </a>
            <a href="/gas" className="text-sm text-stone/80 transition hover:text-parchment">
              Gas
            </a>
